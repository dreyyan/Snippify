const Styles = {
    ...
    folderShortcut: "text-xs text-left pl-4 font-semibold py-2 cursor-pointer",
    fileItem: "flex justify-between px-4 py-1 text-sm shadow-xs w-full bg-[var(--background)] border hover:border-t-red-500 cursor-pointer"
};
