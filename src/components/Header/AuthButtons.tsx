...
const AuthButtons = () => {
    return (
        <div className="space-x-4 [&>button]:cursor-pointer">
            ...
            <button className="text-sm font-bold px-4 py-2 rounded-full text-[var(--text-on-primary)] bg-[var(--primary)] transition-all duration-200 hover:bg-[#0081AF] hover:scale-102">Get Started</button>
        </div>
    );
};
