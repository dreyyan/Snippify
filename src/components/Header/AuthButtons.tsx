...
const AuthButtons = () => {
    ...
    const handleSignUpNavigation = () => { navigate('/sign-up'); };

    return (
        <div className="space-x-4 [&>button]:cursor-pointer">
            <Link to="login" className="text-sm font-[500] tracking-normal text-[var(--text-primary)] transition-colors duration-300 hover:text-[var(--text-secondary)]">Login</Link>
